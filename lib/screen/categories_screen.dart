              ...
              children: [
                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    print(provider.banners.map((e)=>e.image).toList());
                    return Column(
                      children: [
                        Container(
                          height: 90,
                ...
                SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: Row(
                    children: provider.topProducts.map((product) => Padding(
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: const [
                    Text("New Items", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                    Text("See All", style: TextStyle(fontSize: 16, color: Colors.blue)),
                  ],
                ),
                const SizedBox(height: 10),
                SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: Row(
                    children: provider.newProducts.map((product) => Padding(
                      padding: const EdgeInsets.only(right: 8),
                      child: productCard(product),
                    )).toList(),
                  ),
